...
export const TRANSLATIONS = {
  cs: {
    ...
    dailyTip6: 'Nouzová rezerva = 3-6 měsíců výdajů. Bez ní jsi na tenkém ledě 🧊',
    dailyTip7: 'Diverzifikace není o tom mít hodně akcií, ale o tom mít různé typy aktiv 🎯',
    dailyTip8: 'Pravidlo 72: Vyděl 72 výnosem a zjistíš, za kolik let se peníze zdvojnásobí 🔢',
    dailyTip9: 'Investuj do sebe. Vzdělání je investice s nejlepším výnosem 📚',
    dailyTip10: 'Nekup to, co nepotřebuješ, jen proto, že je to ve slevě 🛒',
    dailyTip11: 'Automatizuj spoření. Co nevidíš, neutratíš 🤖',
    dailyTip12: 'Dluh na kreditce s 20% úrokem? Splať ho dřív než investuješ 💳',
    dailyTip13: 'Dollar Cost Averaging: Investuj pravidelně stejnou částku bez ohledu na cenu 📊',
    dailyTip14: 'Nemysli si, že timing trhu je snadný. I profesionálové to nezvládají 🎲',
    dailyTip15: 'Sleduj výdaje alespoň měsíc. Překvapíš se, kam peníze mizí 🔍',
    dailyTip16: 'Index S&P 500 za posledních 30 let průměrně 10% ročně. Pasivní investice funguje 📈',
    dailyTip17: 'Poplatky 2% ročně? Za 30 let přijdeš o polovinu výnosů! ⚠️',
    dailyTip18: 'Nemovitosti nejsou vždy dobrá investice. Počítej všechny náklady 🏠',
    dailyTip19: 'Krypto může být součástí portfolia, ale ne celé portfolio 🪙',
    dailyTip20: 'Životní pojištění s investicí? Raději odděl pojištění a investice 🛡️',
    dailyTip21: 'Rebalancuj portfolio jednou ročně. Udržuj cílovou alokaci ⚖️',
    dailyTip22: 'Daňové zvýhodnění na penzijko? Využij ho, jsou to zadarmo peníze 🎁',
    dailyTip23: 'Neinvestuj do toho, čemu nerozumíš. I když to všichni doporučují 🤔',
    dailyTip24: 'Tvůj největší kapitál? Tvůj čas a zdraví. Investuj do obojího 💪',
    dailyTip25: 'Sleduj čistou hodnotu (assets - dluhy), ne jen příjem 💎',
    dailyTip26: 'Inflace 3% = za 24 let ztratíš polovinu kupní síly 📉',
    dailyTip27: 'Začni investovat i s 500 Kč měsíčně. Důležitý je návyk, ne částka 🌱',
    dailyTip28: 'Emoce jsou největší nepřítel investora. Drž se plánu 🧘',
    dailyTip29: 'Dividendy jsou fajn, ale nezapomeň na daně a celkový výnos 💰',
    dailyTip30: 'Finanční svoboda = pasivní příjem > výdaje. To je cíl 🎯',
  ...
  en: {
    ...
    dailyTip6: 'Emergency fund = 3-6 months of expenses. Without it, you\'re on thin ice 🧊',
    dailyTip7: 'Diversification isn\'t about having many stocks, but different types of assets 🎯',
    dailyTip8: 'Rule of 72: Divide 72 by return rate to find out when money doubles 🔢',
    dailyTip9: 'Invest in yourself. Education has the best ROI 📚',
    dailyTip10: 'Don\'t buy what you don\'t need just because it\'s on sale 🛒',
    dailyTip11: 'Automate savings. What you don\'t see, you don\'t spend 🤖',
    dailyTip12: 'Credit card debt at 20% interest? Pay it off before investing 💳',
    dailyTip13: 'Dollar Cost Averaging: Invest regularly the same amount regardless of price 📊',
    dailyTip14: 'Don\'t think timing the market is easy. Even pros can\'t do it 🎲',
    dailyTip15: 'Track expenses for at least a month. You\'ll be surprised where money goes 🔍',
    dailyTip16: 'S&P 500 averaged 10% annually over 30 years. Passive investing works 📈',
    dailyTip17: '2% annual fees? You\'ll lose half your returns over 30 years! ⚠️',
    dailyTip18: 'Real estate isn\'t always a good investment. Count all costs 🏠',
    dailyTip19: 'Crypto can be part of portfolio, but not the whole portfolio 🪙',
    dailyTip20: 'Life insurance with investment? Better separate insurance and investing 🛡️',
    dailyTip21: 'Rebalance portfolio once a year. Maintain target allocation ⚖️',
    dailyTip22: 'Tax benefits on retirement account? Use it, it\'s free money 🎁',
    dailyTip23: 'Don\'t invest in what you don\'t understand. Even if everyone recommends it 🤔',
    dailyTip24: 'Your biggest capital? Your time and health. Invest in both 💪',
    dailyTip25: 'Track net worth (assets - debts), not just income 💎',
    dailyTip26: '3% inflation = you lose half your purchasing power in 24 years 📉',
    dailyTip27: 'Start investing even with $20/month. Habit matters, not the amount 🌱',
    dailyTip28: 'Emotions are investor\'s biggest enemy. Stick to the plan 🧘',
    dailyTip29: 'Dividends are nice, but don\'t forget taxes and total return 💰',
    dailyTip30: 'Financial freedom = passive income > expenses. That\'s the goal 🎯',
