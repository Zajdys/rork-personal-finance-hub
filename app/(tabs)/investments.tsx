...
export default function InvestmentsScreen() {
  ...
  const portfolioData = useMemo(() => {
    ...
    .map((item) => {
      ...
      console.log(`${item.symbol}: ${item.shares} shares @ ${currentPrice.toFixed(2)} = ${currentValue.toFixed(2)}`);
      return {
        ...item,
      ...
      >
        <View style={styles.headerContent}>
          <View>
            ...
            <Text style={styles.headerSubtitle}>Přehled investic</Text>
          </View>
          <TouchableOpacity 
          ...
          <View style={styles.tradesContainer}>
            {trades.length === 0 ? (
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyStateText}>
                  Přidej svůj první nákup nebo prodej
                </Text>
              </View>
            ) : (
              <>
